...
class SmartInstantVoiceNotepad:
    def __init__(self, root):
        self.root = root
        self.root.title("🎤 АРДУМГНОВЕННЫЙ ГОЛОСОВОЙ БЛОКНОТ")
        ...
        # Стили
        style = ttk.Style()
        style.configure('TButton', font=('Arial', 10, 'bold'), padding=8, background='#3498db', foreground='white')
        ...
        # Заголовок
        title_label = ttk.Label(main_container, text="🎤 УМНЫЙ МГНОВЕННЫЙ ГОЛОСОВОЙ БЛОКНОТ", style='Title.TLabel')
